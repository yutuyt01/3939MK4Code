...
public final class Constants {
    ...
    public static final class DriveConstants {
        ...
        public static final int kFrontLeftDriveMotorPort = 41;   //FL
        public static final int kBackLeftDriveMotorPort = 27;    //BL
        public static final int kFrontRightDriveMotorPort = 28;  //FR
        public static final int kBackRightDriveMotorPort = 43;   //BR

        public static final int kFrontLeftTurningMotorPort = 42;     //FL
        public static final int kBackLeftTurningMotorPort = 40;      //BL
        public static final int kFrontRightTurningMotorPort = 24;    //FR
        public static final int kBackRightTurningMotorPort = 23;     //BR
